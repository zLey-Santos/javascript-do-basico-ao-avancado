// nos  dois exmplos abaixo o sinal de mais esta somando
console.log(1 + 1);
console.log(25 + 50);

// nos exemplos abaixo  o sinal de mais (+) está concatenado
console.log("wesley " + "santos");
console.log("Nome:" + "Wesley Santos" + ", " + "idade:" + 30);

// nesse caso ele concatena o 30 + 1 = retornando 301
